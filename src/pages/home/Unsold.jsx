  ...
  return (
    <Layout>
      <div className="body-container sm:ml-64">
        <div className="flex items-center justify-between header-container unsold-table-head">
          <h6 className="header-text unsold-text">Unsold Order</h6>
          <button
            type="button"
            onClick={openModal}
            className="new-btn new-unsold"
          >
            Add Unsold
          </button>
        </div>
        ...
        <div className="rounded-lg mt-3 relative table-container">
          <table className="w-full text-sm text-left rtl:text-right">
            <thead className="text-xs text-gray-900 uppercase unsold-table-head">
              <tr>
